...
<?php include('header.php'); ?>
	...
	<div class="recipient_reg" style="background-color:#272327;">
		<h3 class="text-center" style="background-color:lightgrey;color: black;">Add Unregistered Doctor Information...</h3>
					...
					$conn= mysqli_connect('localhost', 'root', '','pregnancy');
						 if(isset($_POST['submit'])){
							...
							if(move_uploaded_file($_FILES["pic"]["tmp_name"], $target_file)) {
									include('../dbconn.php');
									$query = "SELECT * FROM doctor WHERE userid='".$_POST["userid"]."' OR email= '" . $_POST["email"] . "' ";
									...
									$sql = "INSERT INTO doctor (name,address,contact,email,expertise,userid,password,pic)
