...
<body>
	...
	<div class="container">
		<div class="header_top">
			<span style="font-size:50px;color:#2c2f84;font-weight:bolder;margin-left:15px;">Medical Management System</span>
		</div>
	...
	<div class="login">
		<!-- <h1 class="text-center" style="background-color:;color: #fff;">Admin Panel</h1> -->
			<div class="formstyle" style="padding: 10px;border: 1px solid lightgrey;margin-right: 376px;margin-left: 406px; margin-bottom: 25px;background-color:white;">
			...
			<?php 
							...
							$sql= "SELECT * FROM adminreg WHERE username= '" . $_POST["username"]."' AND password= '" . $_POST["password"]."'";
